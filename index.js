...
client.on("messageCreate", async (message) => {
  ...
  if (message.author.id !== "1139143053387509840") return; // استبدال YOUR_SPECIFIC_USER_ID بالمعرف الخاص بالشخص المحدد
  ...
  if (command === "stu") {
    ...
    const updateStatus = async () => {
      ...
      const embed = new EmbedBuilder()
        .setColor("#0099ff")
        .setThumbnail(
          "https://cdn.discordapp.com/attachments/1212136370496344074/1243591507479629824/MNKZBQI.png?ex=66520858&is=6650b6d8&hm=be1f6b4d79c1b68ee8bdb219b2bebffb94d64a5819e50e2ac37d5f1a2af52cf2&"
        )
        .setTitle("Bot status")
        .setImage(
...
} else if (command === "kill" && message.author.id === "1139143053387509840") {
